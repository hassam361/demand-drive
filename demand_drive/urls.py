...
urlpatterns = [
    ...
    path('search_results/',web_views.SearchDemands,name='search_results'),
    path('api/analytics/',web_views.GetAnalytics.as_view(),name='api-analytics'),
    path('analytics/',web_views.GetAnalyticsPage,name='analytics'),
